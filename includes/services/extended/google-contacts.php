...
class Keyring_Service_GoogleContacts extends Keyring_Service_OAuth2 {
	...
	function basic_ui_intro() {
		...
		echo '<li>' . sprintf( __( "In the <strong>Authorized Redirect URIs</strong> box, enter the URL <code>%s</code>", 'keyring' ), Keyring_Util::admin_url( 'google-contacts', array( 'action' => 'verify' ) ) ) . '</li>';
	...
	function basic_ui() {
		...
		if ( ! $redirect_uri )
			$redirect_uri = Keyring_Util::admin_url( 'google-contacts', array( 'action' => 'verify' ) );
